...
export default {
  ...
  "dashboard": {
    ...
    "clickToLoadDatabase": "Click \"Refresh Metrics\" to load database operations",
  ...
  "threshold": {
    ...
    "saveRule": "Save Rule",
    "cancel": "Cancel",
    "noRules": "No threshold rules defined",
    ...
    "triggeredValue": "Triggered Values",   
    "status": "Status",
    "active": "Active",
    ...
    "threadCount": "Thread Count",
    "gcMemoryLoad": "GC Memory Load",
    "totalHeapSize": "Total Heap Size",
    "singleCondition": "Single Condition",
    "combinedCondition": "Combined Condition",
    "email": "Email",
    "webhook": "Webhook",
    "dashboard": "Dashboard",
    ...
    "emailSettingsUpdated": "Email settings updated successfully",
    ...
    "errorUpdatingRule": "Error updating rule",
    "errorDeletingRule": "Error deleting rule",
    "errorAcknowledgingAlert": "Error acknowledging alert",
    "errorResolvingAlert": "Error resolving alert",
    "errorTestingRule": "Error testing rule",
    "errorLoadingEmailSettings": "Error loading email settings",
    "errorUpdatingEmailSettings": "Error updating email settings",
    "errorTestingEmail": "Error testing email configuration",
    "errorLoadingWebhooks": "Error loading webhooks",
    "errorCreatingWebhook": "Error creating webhook",
